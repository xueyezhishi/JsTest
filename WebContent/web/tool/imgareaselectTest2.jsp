...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/leaflet.css"/>
...
<script src="<%=request.getContextPath()%>/js/ComJs/require.js"></script>
...
/* 	$('#photo').imgAreaSelect({ x1: 120, y1: 90, x2: 280, y2: 210 }); */
     ...
     inputBtn.addEventListener('click',addClickLatlng,false);//鼠标单击的时候调用showMes这个函数  
 //    addClickLatlng();
...
<!--         <area shape ="polygon" coords ="400,400,500,400,600,450" id = "1214"  /> -->
       <!--  <area shape ="polygon" coords ="0,0,0,100,150,100,150,0,0,0,20,20,20,80,130,80,130,20,20,20" id = "1214"  /> -->
        <area shape ="polygon" coords ="0,0,500,0,500,50,50,50,50,300,500,300,500,350,50,350,0,350" id = "1214"  />
    </map>
