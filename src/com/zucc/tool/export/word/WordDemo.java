package com.zucc.tool.export.word;
...
public class WordDemo {
    ...
    public static void demo(String url)throws IOException, DocumentException{
        WordUtils wordUtils = new WordUtils();
 //       wordUtils.openDocument("D:\\wordDemo.doc");
        wordUtils.openDocument(url);
        //第一级标题样式
        ...
        wordUtils.insertTitlePattern("一、基本内容111",rtfGsBt1);
